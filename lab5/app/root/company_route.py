...
from ..domain.company import Company, create_dynamic_tables_from_companies
...
@company_bp.route('/create_dynamic_tables', methods=['POST'])
def create_tables_endpoint():
    table_names = create_dynamic_tables_from_companies()
...
def insert_schedule_supplements_record():
    return insert_record(Company, request.get_json())